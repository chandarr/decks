...
(function () {
    ...
    return `
      <section class="screen screen--what-changes">
        <div class="wc-header">
          ...
          <h1 class="display-2">The market doesn't get faster. It gets bigger.</h1>
          <p class="subtitle">And the work of capturing it is not the model.</p>
        </div>
        ...
        <div class="wc-closing">
          ...
          <p class="wc-closing-block reveal" data-side="right">Four of five, we already hold.<br>The fifth is the whole argument.</p>
        </div>
      </section>
    `;
  }
  ...
  window.page({
    id: "05-what-changes",
    title: "The market doesn't get faster. It gets bigger.",
    theme: "light",
    steps: 7,
    render,
    onEnter: (root, ctx) => {
