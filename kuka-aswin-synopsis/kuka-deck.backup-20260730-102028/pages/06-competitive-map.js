 ...
 *
 * NOTE FOR THE BUILD LOG: the vectors as given in tasks/06-competitive-map.md
 * point three of five clusters (modern-mfg, humanoids, physical-ai-software)
 * up-LEFT, while the acceptance criteria require "all arrows visibly point
 * into" an upper-RIGHT convergence region. Implemented exactly as specified
 * — see the session report for the flag on this.
 */
(function () {
        ...
        <div class="map-body">
          <div class="map-wrap">
            <svg class="map-svg" viewBox="0 0 900 520" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
              ...
              <text class="map-kuka-label" x="${kukaPos.x + 18}" y="${kukaPos.y + 5}">KUKA</text>
            </svg>
          </div>
