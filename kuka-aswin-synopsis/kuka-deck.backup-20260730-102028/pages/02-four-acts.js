      ...
      <section class="screen screen--four-acts">
        ...
        <div class="fa-columns">
          <div class="fa-col">
            ...
            <p class="fa-col-label">ACT I</p>
            <p class="fa-col-beat step" data-step="1">The market is inflecting</p>
          </div>
          <div class="fa-col">
            <div class="fa-col-rule"></div>
            <p class="fa-col-label">ACT II</p>
            <p class="fa-col-beat step" data-step="2">KUKA is well-placed and under-armed</p>
          </div>
          <div class="fa-col">
            <div class="fa-col-rule"></div>
            <p class="fa-col-label">ACT III</p>
            <p class="fa-col-beat step" data-step="3">India is where that gap is widest</p>
          </div>
          <div class="fa-col">
            <div class="fa-col-rule"></div>
            <p class="fa-col-label">ACT IV</p>
            <p class="fa-col-beat step" data-step="4">And where the fix compounds globally</p>
          </div>
        </div>
      </section>
    `;
