...
window.DeckData = {
  ...
  KUKA_STACK: [
    {
      work: "fine-tune on our own robot models",
  ...
  FLYWHEEL: [
    ...
    },
    {
      ...
      sub: "Thousands of task types no Western or German factory runs — funded by RaaS",
      tier: "frontier",
    },
    {
      id: "data",
    ...
    {
      id: "finetune",
      label: "FINE-TUNED ON OUR OWN ROBOTS",
      sub: "Our kinematics, our torque sensing, our safety case, our installed base",
      tier: "confirmed",
