...
01-cover              dark    ACT I
02-four-acts          light
02a-act-i             light   ← ACT I divider
03-inflection         light
04-signals            light
05-what-changes       light
05a-act-ii            light   ← ACT II divider
...
**The four act dividers were added after the content screens** (`tasks/00-act-dividers.md`).
The deck is dense, so each act now opens with a breath: one screen naming the act, its title and
its beat line, with no steps to advance through. They share one implementation in
`act-divider.js` and take letter-suffixed numbers so the fifteen content screens keep the file
names, ids and task files they were built with. **The deck is 19 screens.**
